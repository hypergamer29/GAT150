...
#define CREATE_CLASS(classname) Loki::Factory::Instance().Create<Loki::classname>(#classname);
#define CREATE_CLASS_BASE(classbase, classname) Loki::Factory::Instance().Create<Loki::classbase>(classname);
#define INSTANTIATE(classbase, classname) Loki::Factory::Instance().Create<Loki::classbase>(classname);
